        ...
        <Carousel autoplay arrows>
            <div className="w-full h-[550px] relative">
                ...
                <div className="absolute top-1/2 left-15 z-2 -translate-y-1/2 text-white">
                    <h2 className="text-6xl font-bold">Titulo chamativo</h2>
                    <p className="w-[350px] mt-4 mb-8 text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi earum optio eligendi voluptatum aspernatur ipsam.</p>
